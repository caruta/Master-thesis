...
A SSB occurs in physics when the vacuum state of a system (which is the lowest energy state) is not invariant under a symmetry transformation of the Lagrangian which describes that system. Therefore this symmetry is said to be \emph{spontaneously broken} and a degeneracy is always implied!
